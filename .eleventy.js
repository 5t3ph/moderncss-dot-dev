...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addShortcode(
    "codeDemo",
    function (css, html, resize, placeCenter) {
      if (!css) {
        return `
<div class="demo">
...
${htmlCode}
  ...
  eleventyConfig.addShortcode("postToCodepen", (title, slug, css, html) => {
    ...
    return `<form action="https://codepen.io/pen/define" method="POST" target="_blank">
        ...
        <button class="button" type="submit" data-name="${title}" aria-label="Open ${title} in CodePen"><span class="button__icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" focusable="false">
